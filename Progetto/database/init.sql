...
VALUES
('annarita', '$2a$10$zasBP.zYFEKfLbGkdP.WlOiT2qPyvh8Nq2X3O8l158cHKvdfhOu9W', 'user'),
('giuseppe', '$2a$10$zasBP.zYFEKfLbGkdP.WlOiT2qPyvh8Nq2X3O8l158cHKvdfhOu9W', 'user'),
...
-- node -e "require('bcrypt).hash('PASSWORD_HERE', SALT_ROUNDS).then(h => console.log(h))"
